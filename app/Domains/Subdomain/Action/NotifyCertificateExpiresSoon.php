...
class NotifyCertificateExpiresSoon extends ActionAbstract
{
    /**
    ...
    {
        $this->expiresDate = date('Y-m-d', strtotime('+'.app('configuration')->get('subdomain_notify_certificate_expires_days').' days'));
    ...
    protected function mail(): void
    {
        if ($this->list->isNotEmpty()) {
            $this->factory()->mail()->certificateExpiresSoon($this->list, $this->emails);
        }
    }
}
